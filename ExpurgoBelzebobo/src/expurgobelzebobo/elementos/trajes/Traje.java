...
public abstract class Traje {
    ...
    private final float fatorDefesa; // Bônus de defesa concedido ao personagem de classe com mesmo atributo
    private boolean liberado;        // Liberadade para utilização
    
    // Construtor para criação do traje

    public Traje(String nome, String atributo, float fatorAtaque, boolean liberado) {
        this.nome = nome;
